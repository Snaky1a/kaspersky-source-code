...
#if !defined( __public_plugin_resip )
#define __public_plugin_resip
// AVP Prague stamp end
...
// AVP Prague stamp begin( Plugin public definitions, ipresolver )
