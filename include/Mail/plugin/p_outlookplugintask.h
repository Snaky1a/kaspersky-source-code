...
// -------- Thursday,  18 November 2004,  17:51 --------
// -------------------------------------------
...
#if !defined( __public_plugin_outlookplugintask )
#define __public_plugin_outlookplugintask
// AVP Prague stamp end
...
#define PID_OUTLOOKPLUGINTASK  ((tPID)(40017))
// AVP Prague stamp end
...
#endif // __public_plugin_outlookplugintask
// AVP Prague stamp end
