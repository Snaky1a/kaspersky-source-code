...
#if !defined( __public_plugin_processmonitor )
#define __public_plugin_processmonitor
// AVP Prague stamp end
...
#define PID_PROCESSMONITOR  ((tPID)(49035))
// AVP Prague stamp end
...
// AVP Prague stamp begin( Plugin public definitions, ProcessMonitor )
...
#endif // __public_plugin_processmonitor
// AVP Prague stamp end
